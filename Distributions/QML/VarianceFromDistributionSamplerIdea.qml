...
Item
{
    ...
    function nextSample()
    {
        ...
        else
        {
            ...
            var comp = Qt.createComponent("VarianceFromDistributionSamplerBars.qml");
            var obj = comp.createObject(stdevMeanBarsArea,{x: meanPos - 1,
                                            stdevLength: stdevLength});
            obj.startAnimating();

            comp = Qt.createComponent("VarianceFromDistributionVarianceBox.qml");
            obj = comp.createObject(stdevDotsArea,{x: meanPos, y: 110,
                                        stdevLength: stdevLength,
