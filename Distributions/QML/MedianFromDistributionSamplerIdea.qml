...
Item
{
    ...
    Item
    {
        ...
        Component.onCompleted:
        {
            ...
            {
                var comp = Qt.createComponent("MedianFromDistributionSamplesDot.qml");
        ...
        else
        {
            ...
            for(var i = 0; i < distributionSamplesDotArea.numSampleDots; i++)
            {
                distributionSamplesDotArea.children[i].startAnimating(i, distSamplesPos[i],
                                                                      meanPos.x,
                                                                      1.0 - Math.abs((distributionSamplesDotArea.numSampleDots - 1)/2 - i) /
                                                                      ((distributionSamplesDotArea.numSampleDots - 1)/2));
            }
