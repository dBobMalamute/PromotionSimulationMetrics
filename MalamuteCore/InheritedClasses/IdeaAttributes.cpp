...
bool IdeaAttributes::customLabelColors() const
{
    return m_customLabelColors;
}
...
QList<QColor> IdeaAttributes::labelsInColors() const
{
    return m_labelsInColors;
}

QList<QColor> IdeaAttributes::labelsOutColors() const
{
    return m_labelsOutColors;
}
