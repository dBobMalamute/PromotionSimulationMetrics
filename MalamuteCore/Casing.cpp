...
void Casing::setupInPlugs()
{
    ...
    else if(attributes.customLabelColors())
        m_inPlugLabelColors = attributes.labelsInColors();
    else
    {
        for(int i = 0; i < m_inPlugs; i++)
            m_inPlugLabelColors.append(QColor("#a6b0cb"));
    }
...
void Casing::setupOutPlugs()
{
    ...
    if(m_backend->idea()->outPortLabelColors().size() != 0)
    {
        ...
        m_outPlugLabelColors = attributes.labelsOutColors();
    else
    {
        for(int i = 0; i < m_outPlugs; i++)
            m_outPlugLabelColors.append(QColor("#a6b0cb"));
    }
...
QColor Casing::inPlugLabelColor(int plug)
{
    return m_inPlugLabelColors.at(plug);
}

QColor Casing::outPlugLabelColor(int plug)
{
