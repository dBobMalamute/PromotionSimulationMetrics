...
ApplicationWindow
{
    ...
    Action
    {
        id: casingMenuSetColor7
        text: "Red"
        onTriggered:
        {
            corkboard.setColorFromCasingMenu(6);
        }
    }
    Action
    {
        id: casingMenuSetColor8
        text: "White"
        onTriggered:
        {
            corkboard.setColorFromCasingMenu(7);
        }
    }
    Action
    {
        id: casingMenuSetColor9
        text: "Black"
        onTriggered:
        {
    ...
    Menu
    {
        ...
        Menu
        {
            ...
            MenuItem{action: casingMenuSetColor7; icon.source: "/Images/CasingColors7.png"; icon.color: "transparent"}
            MenuItem{action: casingMenuSetColor8; icon.source: "/Images/CasingColors8.png"; icon.color: "transparent"}
            MenuItem{action: casingMenuSetColor9; icon.source: "/Images/CasingColors9.png"; icon.color: "transparent"}
        }
